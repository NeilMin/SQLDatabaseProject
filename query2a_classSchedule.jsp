        ...
        <td>
            ...
            <%
                ...
                if ( action != null && action.equals("showAllClasses")) {
                    ...
                    // without meeting_dow
                    //pstmt = connection.prepareStatement("SELECT distinct stu.ssn, stu.firstname, stu.lastname, class1.title AS noClassTitle, class1.course_id AS noCourseId,      meeting_1.mDate AS noDay,      meeting_1.starttime AS noStart,      meeting_1.endTime AS noEnd,      class_2.title AS conflictingClassTitles,      class_2.course_id AS conflictingCourseId,      meeting_2.startTime AS conflictingStart,      meeting_2.endTime AS conflictingEnd,     c1.course_number as noCourse,     c2.course_number as nowCourse FROM student stu, section section1, class class1, meeting meeting_1,      section section_2, class class_2, meeting meeting_2, course_enrollment stu_sec_2, course as c1, course as c2    WHERE stu.ssn = ? AND stu.student_id = stu_sec_2.student_id      AND stu_sec_2.section_id = section_2.section_id AND section_2.class_id = class_2.class_id      AND meeting_2.section_id = section_2.section_id AND class_2.currently_offered = 'yes'      AND section1.class_id = class1.class_id      AND meeting_1.section_id = section1.section_id AND class1.currently_offered = 'yes'     AND CAST( meeting_2.startTime AS Time) < CAST(meeting_1.endTime AS Time)      AND CAST(meeting_2.endTime AS Time) > CAST(meeting_1.startTime AS Time)     AND meeting_2.section_id <> meeting_1.section_id     and class1.course_id = c1.course_id     and class_2.course_id = c2.course_id ");
