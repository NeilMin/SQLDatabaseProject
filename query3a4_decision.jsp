        ...
        <td>
            ...
            <%
                ...
                if (action != null && action.equals("course")) {
                    ...
                    // prepare statement
                    prepare_statement = connection.prepareStatement("select distinct cc.course_id, cc.course_number, f.faculty_name, f.faculty_id  from classes_taken_in_the_past as ctp, course as cc, faculty_teach as ft, faculty as f where ctp.course_id = cc.course_id     and ft.faculty_id = f.faculty_id     and cc.course_id = ?     and ft.course_id = cc.course_id order by cc.course_id");
                    ...
                    <form action="query3a4_decision.jsp" method="POST">
                        ...
                        <%
                            ...
                            <option value='<%=result_2.getString("faculty_id")%>'>
                                    <%=result_2.getString("faculty_name")%>
                            </option>
                            <%
                            }
                        %>
                ...
                if (action != null && action.equals("prof")) {
                    ...
                    prepare_statement = connection.prepareStatement("with rep as (         select c.course_id, c.course_number,f.faculty_name, ctp.grade  from course as c, faculty_teach as ft, faculty as f, classes_taken_in_the_past as ctp where c.course_id = ft.course_id     and f.faculty_id = ft.faculty_id     and c.course_id = ?    and f.faculty_id = ?     and ctp.course_id = c.course_id     and ctp.quarter = ft.teach_time     and ctp.grading_option LIKE 'letter%' )    ,        sub as (       select *, gc.number_grade as gradePoint   from rep, grade_conversion as gc   where rep.grade = gc.letter_grade          )              select sub.course_number, sub.faculty_name, (ROUND(AVG(sub.gradepoint)::numeric,3) ) as avgPoint    from sub    group by sub.course_number,sub.faculty_name");
                    ...
                    prepare_statement = connection.prepareStatement("with rep as (         select c.course_id, c.course_number,f.faculty_name, s.ssn, s.firstname, ctp.grade  from course as c, faculty_teach as ft, faculty as f, classes_taken_in_the_past as ctp, student as s where c.course_id = ft.course_id     and f.faculty_id = ft.faculty_id     and c.course_id = ?     and f.faculty_id = ?     and ctp.course_id = c.course_id     and ctp.quarter = ft.teach_time     and s.student_id = ctp.student_id     and ctp.grading_option LIKE 'letter%' )        select *, gc.number_grade as gradePoint   from rep, grade_conversion as gc   where rep.grade = gc.letter_grade  ");
                ...
                %>
                    ...
                    <tr>
                        ...
                        <td>
                            <%=result_4.getString("faculty_name")%>
                        </td>
                        <td>
                   ...
                   <%   
                    ...
                    <tr>
                        ...
                        <td>
                            <%=result_5.getString("faculty_name")%>
                        </td>
                        <td>
