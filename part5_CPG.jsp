        ...
        <td>
            ...
            <%
                ...
                if (action != null && action.equals("course")) {
                    ...
                    <form action="part5_CPG.jsp" method="POST">
