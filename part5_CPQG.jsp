        ...
        <td>
            ...
            <%
                ...
                if (action != null && action.equals("course")) {
                    ...
                    <form action="part5_CPQG.jsp" method="POST">
