                ...
                if (action != null && action.equals("course")) {
                   ...
                   <%   
                    ...
                    <tr>
                        ...
                        <td>
                            <%=result_6.getString("faculty_name")%>
                      </td>
                      <td>
