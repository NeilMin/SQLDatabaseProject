    ...
    <tr>
        ...
        <td>
            ...
            <%
                ...
                // all students ever enrolled
                result = statement.executeQuery("SELECT distinct stu.firstname AS first, stu.middlename AS middle, stu.lastname AS last, stu.ssn AS ssn FROM student stu order by stu.ssn");
                
                // only students enrolled now
