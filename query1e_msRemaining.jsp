    ...
    <tr>
        ...
        <td>
            ...
            <%
                ...
                result_2 = statement2.executeQuery("select d.cur_degree, dp.department_name from degree_requirements as d, department as dp where d.department_id = dp.department_id and d.cur_degree LIKE 'M.S.%'  ");
